...
<body class="overflow-x-hidden">
    <section class="bg-biru-tua pt-40 pb-20">
        <nav class="py-3 px-14 flex items-center justify-between bg-beige fixed top-0 z-10 w-full">
            ...
            <a class="font-medium text-lg ml-2 hover:bg-biru_hover hover:text-white py-3 px-4 rounded-full duration-300 @if(Str::startsWith(Request::path(), 'detail_postingan')) bg-biru_hover text-white @endif" href="{{route('user.postingan')}}" >Postingan</a>
        ...
        <div class="flex flex-row justify-between px-32 py-0 mt-3 ">
            ...
            <div class="ml-8" data-aos="fade-left" data-aos-duration="2000">
                <img src="/images/postingan.svg" alt="">
            </div>
        </div>     
</section>
...
<section class="bg-beige h-auto px-20 py-20  justify-center items-center">
    <div class="bg-white drop-shadow-xl px-20 py-20 w-full p-24 rounded-xl h-auto" data-aos="fade-up" data-aos-duration="2000">
        <div class="flex">
           <div data-aos="fade-up" data-aos-duration="2000">
            <img class="rounded-2xl" src="{{ Storage::url($detail->gambar) }}" alt="Postingan Satu" style="width: 200px">
           </div>
            <div class="ml-20 mt-10" data-aos="fade-up" data-aos-duration="2000">
                <p class="font-bold text-4xl">{{$detail->nama}}</p>
            </div>
        </div>
    
        <div class="mt-12" data-aos="fade-up" data-aos-duration="2000">
