...
<section class="bg-white h-auto">
    <nav class="py-10 mx-16 flex items-center justify-between active">
        ...
        <a class="font-medium ml-3 hover:bg-biru_hover hover:text-white py-3 px-4 rounded-full duration-300 @if(Str::startsWith(Request::path(), 'admin/tambah/karir')) bg-biru_hover text-white @endif" href="{{route('admin_karir')}}" >Karir</a>
    ...
    <div class="flex items-center">
        <div class="ml-20">
            <p class="text-4xl font-bold">Tambah Karir</p>
...
<div class="ml-20 mt-10 ">
    ...
    <input type="text" id="judul" name="nama_lowongan" class="block text-gray-900 rounded-xl w-96 border-2 mt-2  bg-gray-50 text-base" placeholder="Nama Lowongan">
</div>

<div class="mx-20 mt-5">
    <label for="Deskripsi" class="block mb-2 font-medium text-gray-900">Deskripsi Pekerjaan</label>
    <textarea type="text" id="Deskripsi" name="deskripsi_pekerjaan" class="block w-full h-40 text-gray-900 rounded-xl border-2 mt-2bg-gray-50" placeholder="Deskripsi Pekerjaan"></textarea>
</div>

<div class="mx-20 mt-5">
    <label for="Deskripsi" class="block mb-2 font-medium text-gray-900">Syarat dan Ketentuan</label>
    <textarea type="text" id="Deskripsi" name="syarat_ketentuan" class="block w-full h-40 text-gray-900 rounded-xl border-2 mt-2bg-gray-50" placeholder="Syarat dan Ketentuan"></textarea>
</div>

<div class="ml-20 mt-5 ">
    <label for="judul" class="block mb-2 font-medium text-gray-900">Tahap Rekrutmen</label>
    <input type="text" id="judul" name="tahap_rekrutmen" class="block text-gray-900 rounded-xl w-96 border-2 mt-2  bg-gray-50 text-base " placeholder="Tahap Rekrutmen">
</div>
...
<div class="ml-20 mt-5 ">
    ...
    <input type="file" id="formulir" name="formulir" required accept=".pdf" class="block text-gray-900 rounded-xl w-96 border-2 mt-2  bg-gray-50 text-base ">
</div>
