...
<section class="bg-white h-auto">
    <nav class="py-10 mx-16 flex items-center justify-between active">
        ...
        <a class="font-medium ml-3 hover:bg-biru_hover hover:text-white py-3 px-4 rounded-full duration-300 @if(Str::startsWith(Request::path(), 'admin/edit/dokumen')) bg-biru_hover text-white @endif" href="{{route('admin_dokumen')}}" >Dokumen</a>
    ...
    <div class="flex items-center">
        <div class="ml-20">
            <p class="text-4xl font-bold">Edit Dokumen</p>
            <p class="mt-3">Edit data dokumen dengan mengisi form.</p>
        </div>
    </div>
...
<div class="ml-20 mt-10 ">
    ...
    <input type="text" id="judul" name="nama" value="{{ $dokumen->nama }}" class="block text-gray-900 rounded-xl w-96 border-2 mt-2  bg-gray-50 text-base placeholder: ">
</div>
...
<div class="ml-20 mt-5 mb-20 ">
    ...
    <input type="date" id="tanggal" name="tanggal_upload" value="{{ $dokumen->tanggal_upload }}" class="block text-gray-900 rounded-xl w-96 border-2 mt-2  bg-gray-50 text-base ">
</div>

<div class="flex justify-center gap-5 mb-20 items-center">
    <div class="justify-center">
        <a class="py-3 px-5 bg-merah text-white rounded-full font-semibold hover:bg-red-700" href="{{route('admin_dokumen')}}">Kembali</a>
    </div>
    
    <div class="justify-center">
        <button type="submit" class="bg-blue-600 py-3 px-5 rounded-full text-white font-semibold hover:bg-blue-700 hover:duration-300">Simpan</button>
    </div>
</div>
</form>
