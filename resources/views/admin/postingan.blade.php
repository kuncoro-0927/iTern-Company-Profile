...
<div class="flex items-center">
    <div class="ml-20">
        <p class="text-4xl font-bold">Postingan</p>
        <p class="mt-3">Tabel data seluruh postingan ada di halaman ini.</p>
        
    </div>
    <div class="ml-auto mr-20">
        <a href="{{route('postingan.tambah')}}" class=" ml-20 py-3 px-4 bg-biru-tua hover:bg-biru_hover text-white rounded-full">Tambah</a>
    </div>
</div>
                            ...
                            <tr>
                                ...
                                <td class="py-5 border-b border-gray-200 bg-white text-sm">
                                    <div
                                        ...
                                        <a href="{{ route('postingan.edit', $doc->id) }}" class="relative">Edit</a>
                                    </div>
                                    <div
     ...
     <div class="relative p-4 w-full max-w-md h-full md:h-auto">
         ...
         <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
             ...
             <div class="flex justify-center items-center space-x-4">
                 ...
                 <form action="{{ route('postingan.destroy', $doc->id) }}" method="POST">
                     @csrf
                     @method('DELETE')
